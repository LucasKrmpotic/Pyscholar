...
class ItemTestCase(unittest.TestCase):
    ...
    def test_get_columns(self):
        ...
        self.assertEqual(len(columns), len(self.item.get_columns()))
        self.assertEqual(set(columns), set(self.item.get_columns()))

    def test_to_storage(self):
        self.assertEqual(list, type(self.item.to_storage()))
        self.assertEqual(len(self.item.get_columns()), len(self.item.to_storage()))
